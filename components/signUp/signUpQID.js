...
export default class SignUpQID extends Component {
            ...
            <View style={styles.background}>
                ...
                <View style={styles.questionSection}>
                    <View style={styles.firstRowSection}>
                        <View style={{flex: 1,}}>
                            <Text style={styles.qText}>Enter your QID number</Text>
                        </View>
                        <View style={styles.qidInput}>
                            <TextInput style={{fontSize: 20}} placeholder={'QID'}
